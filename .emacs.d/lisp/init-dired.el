  ...
  '(progn
     ...
     (add-hook 'dired-mode-hook
               (lambda ()
                 ...
                 (define-key dired-mode-map (kbd "M-i")  'switch-window)
                 (define-key dired-mode-map "	"  'switch-window)
                 (define-key dired-mode-map (kbd "M-a") '(lambda () (interactive) (dired-search-word "a")))
                 (define-key dired-mode-map (kbd "M-b") '(lambda () (interactive) (dired-search-word "b")))
                 (define-key dired-mode-map (kbd "M-c") '(lambda () (interactive) (dired-search-word "c")))
                 (define-key dired-mode-map (kbd "M-d") '(lambda () (interactive) (dired-search-word "d")))
                 (define-key dired-mode-map (kbd "M-e") '(lambda () (interactive) (dired-search-word "e")))
                 (define-key dired-mode-map (kbd "M-f") '(lambda () (interactive) (dired-search-word "f")))
                 (define-key dired-mode-map (kbd "M-g") '(lambda () (interactive) (dired-search-word "g")))
                 (define-key dired-mode-map (kbd "M-h") '(lambda () (interactive) (dired-search-word "h")))
                 (define-key dired-mode-map (kbd "M-j") '(lambda () (interactive) (dired-search-word "j")))
                 (define-key dired-mode-map (kbd "M-k") '(lambda () (interactive) (dired-search-word "k")))
                 (define-key dired-mode-map (kbd "M-l") '(lambda () (interactive) (dired-search-word "l")))
                 (define-key dired-mode-map (kbd "M-m") '(lambda () (interactive) (dired-search-word "m")))
                 (define-key dired-mode-map (kbd "M-n") '(lambda () (interactive) (dired-search-word "n")))
                 (define-key dired-mode-map (kbd "M-o") '(lambda () (interactive) (dired-search-word "o")))
                 (define-key dired-mode-map (kbd "M-p") '(lambda () (interactive) (dired-search-word "p")))
                 (define-key dired-mode-map (kbd "M-q") '(lambda () (interactive) (dired-search-word "q")))
                 (define-key dired-mode-map (kbd "M-r") '(lambda () (interactive) (dired-search-word "r")))
                 (define-key dired-mode-map (kbd "M-s") '(lambda () (interactive) (dired-search-word "s")))
                 (define-key dired-mode-map (kbd "M-t") '(lambda () (interactive) (dired-search-word "t")))
                 (define-key dired-mode-map (kbd "M-u") '(lambda () (interactive) (dired-search-word "u")))
                 (define-key dired-mode-map (kbd "M-v") '(lambda () (interactive) (dired-search-word "v")))
                 (define-key dired-mode-map (kbd "M-w") '(lambda () (interactive) (dired-search-word "w")))
                 (define-key dired-mode-map (kbd "M-x") '(lambda () (interactive) (dired-search-word "x")))
                 (define-key dired-mode-map (kbd "M-y") '(lambda () (interactive) (dired-search-word "y")))
                 (define-key dired-mode-map (kbd "M-z") '(lambda () (interactive) (dired-search-word "z")))
